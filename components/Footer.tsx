        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20 text-center md:text-left">
          <div className="flex flex-col items-center md:items-start">
            ...
            <a 
              ...
              className="flex items-center justify-center gap-2 px-8 py-4 border border-[#F97316] rounded-sm text-[12px] font-bold uppercase tracking-[0.2em] text-[#F97316] hover:bg-[#F97316] hover:text-white transition-all active:scale-95 group"
            >
              Book a Call
          ...
          <div className="flex flex-col items-center md:items-end justify-center gap-6">
            <div className="flex gap-8">
              <Link href="https://x.com/DevlyOfficial" target="_blank" className="text-white/40 hover:text-white transition-colors">X</Link>
              <Link href="https://www.instagram.com/devly.official/" target="_blank" className="text-white/40 hover:text-white transition-colors">Instagram</Link>
            </div>
